    ...
    function column_default($item, $column_name) {
        ...
        switch ($column_name) {
            ...
            case 'feedaction':
                ...
                $return  = "<a target='_blank' class='button' href='$view'>" . __('View') . '</a>';
                $return .= "&nbsp;<a class='button' href='$edit'>" . __('Edit') . '</a>';
                $return .= "&nbsp;<a class='button' href='$delete'>" . __('Delete') . '</a>';
            ...
            case 'feedupdate':
                ...
                $return = "&nbsp;<a class='button' href='$update'>" . __('Regenerate') . '</a>';
            ...
            case 'feeddownload':
                ...
                $filename = basename($itemInfo['url'], '.xml');
                ...
                $return = '<a class="button button-secondary" href="'.$download_xml.'" target="_blank">XML</a>';
                $return .= '<a class="button button-secondary" href="'.$download_csv.'" target="_blank">CSV</a>';
