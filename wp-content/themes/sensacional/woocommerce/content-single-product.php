...
<div id="product-<?php the_ID(); ?>" <?php post_class( $single_product_class ); ?>>
						...
						<div class="summary-inner <?php if( $product_design == 'compact' ) echo 'basel-scroll'; ?>">
							<div class="basel-scroll-content">
								...
								?>
									...
									<!-- New product share: Alt buttons in default design -->
									...
									<?php /* Share dependent of product design. Removed.

									if ( $product_design != 'alt' && $product_design != 'sticky' && basel_get_opt( 'product_share' ) ): ?>
									<div class="product-share">
	...
	<?php /* Original share element, it's being moved to original product share.
