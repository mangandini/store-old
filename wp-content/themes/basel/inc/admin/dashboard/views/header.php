    ...
    <div class="about-wrap">
        ...
        <div class="basel-theme-badge">
            ...
            <span><?php
                ...
                echo $theme_version[0] . '.' . $theme_version[1];
            ?></span> 
        </div>
    ...
    <div class="basel-wrap-content">
        ...
        <h2 class="nav-tab-wrapper">
            <?php foreach ($this->get_tabs() as $tab => $title): ?>
                <a class="nav-tab <?php if( $this->get_current_tab() == $tab ) echo 'nav-tab-active'; ?>" href="<?php echo $this->tab_url( $tab ); ?>"><?php echo esc_html( $title ); ?></a> 
            <?php endforeach ?>
        </h2>
